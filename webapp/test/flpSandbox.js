		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creación de Flujo de Aprobación",
									"targetURL": "#zfiflujoreqdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiflujoreqdoc-display": {
								"semanticObject": "zfiflujoreqdoc",
								"action": "display",
								"description": "Aplicación UI5 para crear flujos de aprobación.",
								"title": "Creación de Flujo de Aprobación",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiflujoreqdoc",
									"url": sap.ui.require.toUrl("zfiflujoreqdoc")
								}
							}
						}
					}
